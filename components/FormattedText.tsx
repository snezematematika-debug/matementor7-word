    ...
    <div className={`formatted-text ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          h3: ({node, ...props}) => <h3 className="text-lg font-bold text-slate-800 mt-5 mb-2 block" {...props} />,
          ...
          ul: ({node, ...props}) => <ul className="list-disc pl-5 mb-4 space-y-1 text-slate-700 block" {...props} />,
          ol: ({node, ...props}) => <ol className="list-decimal pl-5 mb-4 space-y-1 text-slate-700 block" {...props} />,
          ...
          hr: ({node, ...props}) => <hr className="my-6 border-slate-300 border-dashed" {...props} />,
          ...
          // Explicitly handle SVG tags if rehype-raw passes them as custom components
